...
|--------------------------------------------------------------------------
*/
$lang['welcome_maintext']                       = 'Willkommen bei %s';
...
$lang['welcometext']    = '<p>Willkommen bei %s.</p>
                          ...
                          <div class="info">
                              ...
                              <ul>
                                    ...
                                    <li>Sie k&ouml;nnen ein Maximum von %s Bonuspunkten f&uuml;r das richtige Tippen auf die totale Anzahl aller Tore erzielen. Wenn Sie nahe dran sind, kriegen Sie auch Bonuspunkte, haben Sie aber %s Tore falsch getippt, bekommen Sie keine Bonuspunkte.</li>
                                    <li>Wenn Sie den Gewinner vom Euro2012 richtig getippt haben, bekommen Sie weitere %s Bonuspunkte</li>
                              </ul>
                          </div>';
$lang['top_10']	= "Top 10";
$lang['points'] = "Punkte";
$lang['see_top_ten'] = "Siehe Tabelle";

$lang['total_money'] = "%s Nutzer haben sich angemeldet. Wenn diese alle bezahlen, besteht die Bank aus %s.";
$lang['money_payed_out'] = "Aus diesem wird %s%% ausbezahlt (das sind %s)";
$lang['money_distribution'] = "Die Auszahlung";
$lang['winner'] =  "Gewinner";
$lang['number'] = "Nummer";
$lang['no_info_yet'] = "Noch keine Daten";
$lang['user_messages'] = "Nutzer Nachricht";
...
/* Location: ./application/language/de/welcome_lang.php */
