...
|--------------------------------------------------------------------------
*/
$lang['welcome_maintext']                       = 'Welcome to %s';


$lang['welcometext']    = '<p>Welcome to %s.</p>
                           <p>Join the competition, it&rsquo;s easier than you think:</p>
                           <ul>
                                <li>Create an account, if you haven&rsquo;t already done that</li>
                                <li>Predict the result of every match. you can change yyour prediction until the match kicks off.</li>
                                <li>Predict the teams that willplay the quarter finals, semi finals and the final. You need to do this before the tournament starts</li>
                                <li>Predict the total number of goals in all 31 matches. You need to do this before the tournament starts</li>
                                <li>Predict who will be the Euro2012 Champion. You need to do this before the tournament starts</li>
                            </ul>
                          <div class="info">
