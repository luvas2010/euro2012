...
?>
	...
	<?php if (logged_in()) { ?>
		<?php if ((Current_User::user()->paid == 0) && ($settings['payment_required'])) : ?>
            <div class="error">
                <p>Volgens de administratie heb je nog niet betaald voor deelname aan de pool. Betaal zo snel mogelijk de &euro;<?php echo $settings['payment_amount']; ?> inschrijfgeld!<br />Als je denkt dat je deze melding ten onrechte ziet, neem dan contact op met <?php echo safe_mailto($settings['admin_email'], 'de beheerder'); ?>.</p>
            </div>
        <?php endif; ?> 
