...
class Account_linked extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model(array('account_model', 'account_details_model', 'account_facebook_model', 'account_twitter_model', 'account_openid_model'));
        ...
        $this->load->language(array('general', 'account_linked', 'connect_third_party'));
    }
    ...
    function index()
    {
        ...
        {
            redirect('account/sign_in/?continue='.urlencode(site_url('account/account_linked')));
        }
        ...
        $data['title'] = lang('linked_page_name');
        $data['content_main'] = "account/account_linked";
